    ...
    <div className="mb-6">
      <form onSubmit={handleSubmit} className="relative">
        <div
          ...
          style={{ background: 'var(--charcoal)', border: '1px solid rgba(74, 222, 128,0.3)' }}
        >
          <div className="pl-4 pr-2 shrink-0" style={{ color: 'rgba(74, 222, 128,0.7)' }}>
        ...
        >
          <div className="flex items-center gap-2 mb-2.5">
            <span
              ...
              style={{ background: 'rgba(74, 222, 128,0.2)', color: 'var(--accent-bright)', letterSpacing: '0.1em' }}
            >
              AI
            </span>
