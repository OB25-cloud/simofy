    ...
    <>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-xs text-ink-muted">{invoices.length} {invoices.length === 1 ? 'invoice' : 'invoices'} total</p>
        </div>
      ...
      {filtered.length === 0 ? (
        ...
        <div className="bg-white rounded-xl border border-line shadow-sm overflow-x-auto">
          <table className="w-full min-w-[640px] text-sm">
            <thead>
              <tr>
                <th className="text-left px-4 py-3 text-[11px] font-semibold text-ink-muted uppercase tracking-[0.08em] bg-surface-muted border-b border-line">Invoice</th>
                ...
                <th className="text-right px-4 py-3 text-[11px] font-semibold text-ink-muted uppercase tracking-[0.08em] bg-surface-muted border-b border-line">GST</th>
                ...
                <th className="text-left px-4 py-3 text-[11px] font-semibold text-ink-muted uppercase tracking-[0.08em] bg-surface-muted border-b border-line">Due Date</th>
                ...
                >
                  ...
                  <td className="px-4 py-3 text-gray-500 max-w-[140px]">
                    {inv.jobs?.title
                      ...
                      : inv.jobs?.job_type
                        ? <span className="block truncate text-ink-muted">{inv.jobs.job_type}</span>
                  ...
                  <td className="px-4 py-3 text-right text-ink-muted tabular-nums text-xs">
                    {fmt(inv.tax)}
                  </td>
