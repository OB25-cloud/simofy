  ...
  return (
    <>
      ...
      <div className="mb-5 relative">
        ...
        <input
          type="text"
          placeholder="Search by invoice ID, client or status…"
          value={search}
      ...
      {filtered.length === 0 ? (
        <div className="rounded-lg border border-gray-100 bg-gray-50 py-16 text-center">
          <p className="text-sm text-gray-400">
            {search ? `No invoices match "${search}"` : 'No invoices yet. Add your first invoice above.'}
          </p>
        </div>
      ) : (
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                <th className="text-left px-5 py-3 font-medium text-gray-400 text-xs uppercase tracking-wider">Invoice</th>
                ...
                <th className="text-left px-5 py-3 font-medium text-gray-400 text-xs uppercase tracking-wider">Due Date</th>
