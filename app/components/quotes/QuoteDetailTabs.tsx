          ...
          <div className="bg-white rounded-xl border border-[#E5E7EB] shadow-sm p-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-3 sm:py-2 text-sm font-medium text-white bg-[#EF4444] rounded-md transition-opacity hover:opacity-90 disabled:opacity-50"
              >
            ...
            {convertError && <p className="mt-2 text-xs text-[#EF4444]">{convertError}</p>}
          </div>
        </div>
      )}
