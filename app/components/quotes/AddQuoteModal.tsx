...
export default function AddQuoteModal({ clients, jobs, onClose }: Props) {
  const [form, setForm] = useState({ client_id: '', job_id: '', status: 'draft', valid_until: '', notes: '' })
  ...
  function removeItem(id: string) { setLineItems(p => p.filter(item => item.id !== id)) }
                  ...
                  <div key={item.id} className="space-y-1.5">
                    ...
                    <div className="grid grid-cols-[60px_1fr_80px_28px] gap-2 items-center">
                      ...
                      <button
                        ...
                        className="flex items-center justify-center w-6 h-6 rounded text-gray-300 hover:text-[#EF4444]/70 hover:bg-red-50 transition-colors disabled:opacity-0"
              ...
              <div className="mt-4 pt-4 border-t border-[#E5E7EB] flex justify-end">
                <div className="w-52 space-y-1.5">
                  <div className="flex justify-between text-sm text-gray-500">
                    <span>Subtotal</span>
                    <span className="tabular-nums">${calc.subtotal.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between text-sm text-gray-500">
                    <span>GST (15%)</span>
