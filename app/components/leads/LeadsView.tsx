  ...
  return (
    <>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-[26px] leading-tight font-bold tracking-tight text-ink">Leads</h1>
          <p className="mt-1 text-xs text-ink-muted">{leads.length} {leads.length === 1 ? 'lead' : 'leads'} total</p>
        </div>
          ...
          <table className="w-full min-w-[640px] text-sm">
            <thead>
              <tr>
                ...
                <th className="text-left px-4 py-3 text-[11px] font-semibold text-ink-muted uppercase tracking-[0.08em] bg-surface-muted border-b border-line">Message</th>
                <th className="text-left px-4 py-3 text-[11px] font-semibold text-ink-muted uppercase tracking-[0.08em] bg-surface-muted border-b border-line">Notes</th>
                <th className="text-left px-4 py-3 text-[11px] font-semibold text-ink-muted uppercase tracking-[0.08em] bg-surface-muted border-b border-line">Source</th>
                <th className="text-left px-4 py-3 text-[11px] font-semibold text-ink-muted uppercase tracking-[0.08em] bg-surface-muted border-b border-line">Received</th>
            ...
            <tbody>
              {filtered.map(lead => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-ink-muted max-w-[140px] text-xs">
                    {lead.notes
