  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="mb-3 bg-surface rounded-xl border border-line shadow-card px-3 py-2.5 flex items-center gap-3">
        ...
        <div className="h-8 w-72 bg-line rounded-lg animate-pulse ml-auto" />
      </div>
        ...
        {[...Array(8)].map((_, i) => (
          <div key={i} className="flex items-center gap-4 px-5 py-3.5 border-b border-line-soft">
            ...
            <div className="flex-1 space-y-1.5">
              ...
              <div className="h-2.5 w-24 bg-line-soft rounded animate-pulse" />
            </div>
            ...
            <div className="h-3 w-40 bg-line-soft rounded animate-pulse" />
            <div className="h-5 w-8 bg-line-soft rounded animate-pulse" />
