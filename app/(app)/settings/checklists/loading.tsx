  ...
  return (
    <div className="h-full flex flex-col">
      <div className="px-6 py-5 border-b border-[#E5E7EB] shrink-0">
        ...
        <div className="h-6 w-52 bg-[#E5E7EB] rounded animate-pulse mb-2" />
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-72 shrink-0 border-r border-[#E5E7EB]">
          <div className="px-4 py-3 border-b border-[#E5E7EB]">
            <div className="h-9 w-full bg-[#E5E7EB] rounded-md animate-pulse" />
          </div>
          {[...Array(4)].map((_, i) => (
            <div key={i} className="px-4 py-3.5 border-b border-[#F4F5F7]">
              <div className="h-3.5 w-32 bg-[#E5E7EB] rounded animate-pulse mb-1.5" />
        ...
        <div className="flex-1 p-6">
          ...
          <div className="bg-white rounded-xl border border-[#E5E7EB] shadow-sm overflow-hidden mb-5">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className={`px-5 py-3.5 flex items-center justify-between ${i > 0 ? 'border-t border-[#F4F5F7]' : ''}`}
              >
                <div className="h-3.5 w-48 bg-[#E5E7EB] rounded animate-pulse" />
