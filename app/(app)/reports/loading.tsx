  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="flex gap-6 border-b border-line mb-6 pb-3">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="h-4 w-20 bg-line rounded animate-pulse" />
        ))}
      </div>
      ...
      <div className="rounded-xl overflow-hidden mb-5" style={{ background: '#111' }}>
        <div className="flex items-center px-6 py-4 border-b" style={{ borderColor: 'rgba(21, 128, 61,0.2)' }}>
          <div className="h-3 w-28 rounded animate-pulse" style={{ background: 'rgba(21, 128, 61,0.2)' }} />
        </div>
      ...
      <div className="grid grid-cols-2 gap-5">
        {[...Array(2)].map((_, i) => (
          <div key={i} className="rounded-xl overflow-hidden" style={{ background: '#111' }}>
            <div className="flex items-center px-6 py-4 border-b" style={{ borderColor: 'rgba(21, 128, 61,0.2)' }}>
              <div className="h-3 w-24 rounded animate-pulse" style={{ background: 'rgba(21, 128, 61,0.2)' }} />
            </div>
