  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="mb-6">
        ...
        <div className="h-4 w-56 bg-[#E5E7EB] rounded animate-pulse" />
      </div>

      {/* Tab bar */}
      <div className="flex gap-6 border-b border-[#E5E7EB] mb-6 pb-3">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="h-4 w-20 bg-[#E5E7EB] rounded animate-pulse" />
        ))}
      </div>
