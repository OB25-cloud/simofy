    ...
    <div className="p-4 md:p-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <div className="h-3.5 w-40 bg-line-soft rounded animate-pulse" />
        </div>
        <div className="flex gap-2">
          <div className="h-9 w-32 bg-line rounded-lg animate-pulse" />
          <div className="h-9 w-24 bg-line rounded-lg animate-pulse" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3 md:gap-4 mb-5">
        <div className="col-span-2 bg-surface rounded-xl border border-line shadow-card px-5 py-4">
          ...
          <div className="h-3 w-48 bg-line-soft rounded animate-pulse mt-3" />
        </div>
        {[...Array(4)].map((_, i) => (
      ...
      <div className="mb-3 bg-surface rounded-xl border border-line shadow-card px-3 py-2.5 flex items-center gap-3">
        <div className="h-8 w-64 bg-line rounded-lg animate-pulse" />
      ...
      <div className="bg-surface rounded-xl border border-line shadow-card overflow-hidden">
        ...
        {[...Array(8)].map((_, i) => (
          <div key={i} className="flex items-center gap-4 px-5 py-3.5 border-b border-line-soft">
            ...
            <div className="h-6 w-28 bg-line-soft rounded animate-pulse" />
            <div className="h-3 w-36 bg-line-soft rounded animate-pulse" />
