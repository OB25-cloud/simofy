  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <div className="h-7 w-16 bg-line rounded animate-pulse mb-2" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3 md:gap-4 mb-5">
        <div className="col-span-2 bg-surface rounded-xl border border-line shadow-card px-5 py-4">
          <div className="h-2.5 w-20 bg-line rounded animate-pulse" />
          <div className="h-10 w-16 bg-line rounded animate-pulse mt-3" />
          <div className="h-3 w-40 bg-line-soft rounded animate-pulse mt-3" />
        </div>
        {[...Array(4)].map((_, i) => (
      ...
      <div className="mb-3 bg-surface rounded-xl border border-line shadow-card px-3 py-2.5 flex items-center gap-3">
        <div className="h-7 w-56 bg-line-soft rounded-lg animate-pulse" />
        <div className="h-7 w-40 bg-line-soft rounded-lg animate-pulse" />
        <div className="h-8 w-64 bg-line rounded-lg animate-pulse ml-auto" />
      </div>
      <div className="mb-4 h-3 w-72 bg-line-soft rounded animate-pulse" />
        ...
        {[...Array(8)].map((_, i) => (
          <div key={i} className="flex items-center gap-4 px-5 py-3.5 border-b border-line-soft">
            ...
            <div className="flex-1 space-y-1.5">
              ...
              <div className="h-2.5 w-16 bg-line-soft rounded animate-pulse" />
            </div>
            <div className="w-48 space-y-1.5">
              <div className="h-2.5 w-28 bg-line-soft rounded animate-pulse" />
              <div className="h-2.5 w-40 bg-line-soft rounded animate-pulse" />
            </div>
