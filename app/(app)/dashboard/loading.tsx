  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <div className="h-7 w-32 bg-[#E5E7EB] rounded animate-pulse mb-2" />
      ...
      <div className="grid grid-cols-5 gap-4 mb-6">
        {[...Array(5)].map((_, i) => (
          <div key={i} className="bg-white rounded-xl border border-[#E5E7EB] shadow-sm p-4">
            ...
            <div className="h-7 w-16 bg-[#E5E7EB] rounded animate-pulse" />
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="bg-white rounded-xl border border-[#E5E7EB] shadow-sm p-5">
          <div className="h-4 w-36 bg-[#E5E7EB] rounded animate-pulse mb-4" />
        ...
        <div className="bg-white rounded-xl border border-[#E5E7EB] shadow-sm p-5">
          <div className="h-4 w-28 bg-[#E5E7EB] rounded animate-pulse mb-4" />
          <div className="space-y-3">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="flex justify-between items-center">
                <div className="h-3.5 w-24 bg-[#E5E7EB] rounded animate-pulse" />
                <div className="h-5 w-8 bg-[#E5E7EB] rounded-full animate-pulse" />
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="space-y-3">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="flex items-center gap-3">
                <div className="h-3.5 w-36 bg-[#E5E7EB] rounded animate-pulse" />
      ...
      <div className="mb-4">
        <div className="h-5 w-36 bg-[#E5E7EB] rounded animate-pulse mb-3" />
        <div className="bg-white rounded-xl border border-[#E5E7EB] shadow-sm overflow-hidden">
          <div className="h-10 bg-[#F4F5F7] border-b border-[#E5E7EB]" />
          {[...Array(2)].map((_, i) => (
            <div key={i} className="h-12 border-b border-[#F4F5F7] px-5 flex items-center gap-6">
              <div className="h-3.5 w-24 bg-[#E5E7EB] rounded animate-pulse" />
      ...
      {/* New leads table */}
      <div>
        <div className="h-5 w-24 bg-[#E5E7EB] rounded animate-pulse mb-3" />
        <div className="bg-white rounded-xl border border-[#E5E7EB] shadow-sm overflow-hidden">
          <div className="h-10 bg-[#F4F5F7] border-b border-[#E5E7EB]" />
          {[...Array(2)].map((_, i) => (
            <div key={i} className="h-12 border-b border-[#F4F5F7] px-5 flex items-center gap-6">
